...
$bdat = '<meta name=\'bangla-date-and-time\' content=\'bdat-v1.6\' />';
...
if( defined( 'WPLANG' ) && ( WPLANG != 'bn_BD' ) ) {

    add_filter('the_date', 'bangla_day_month');
    add_filter('the_time', 'bangla_day_month');
    add_filter('get_comment_date', 'bangla_day_month');
    add_filter('get_comment_time', 'bangla_day_month');
}
